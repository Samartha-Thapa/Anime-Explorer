  ...
  async function onSubmit(data: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      console.error("Error adding class:", error)   
            let errorMessage = "An error occurred while logging account."
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          render={({ field }) => (
            <FormItem>
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-xs text-purple-300 hover:text-pink-400 transition-colors">
                  Forgot password?
                </Link>
              </div>
              <FormControl>
                <div className="relative">
                  ...
                  <Input
                    ...
                    placeholder="••••••••"
                    className="pl-10 pr-10 bg-gray-800/50 border-purple-500/30 focus-visible:ring-purple-500 text-white"
                    {...field}
                  />
                  <button
                    type="button"
          ...
          render={({ field }) => (
            <FormItem className="flex flex-row items-center space-x-2 space-y-0">
              ...
              <div className="space-y-1 leading-none">
                <FormLabel className="text-sm font-normal text-purple-200">Remember me</FormLabel>
              </div>
            </FormItem>
          )}
        /> */}
        <Button
          type="submit"
          className="w-full mt-6 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white border-none shadow-lg shadow-purple-900/30"
          disabled={isLoading}
        >
          {isLoading ? (
