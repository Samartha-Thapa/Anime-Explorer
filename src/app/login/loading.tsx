      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-[10%] left-[5%] animate-float-slow">
          <div className="w-16 h-16 rounded-full bg-pink-500/20 backdrop-blur-sm border border-pink-500/30 flex items-center justify-center">
            <div className="w-10 h-10 rounded-full bg-pink-400/30 animate-pulse"></div>
          </div>
        </div>
        ...
        <div className="absolute bottom-[15%] left-[15%] animate-float-slow">
          <div className="w-24 h-24 rounded-full bg-purple-500/20 backdrop-blur-sm border border-purple-500/30 flex items-center justify-center">
            <div className="w-14 h-14 rounded-full bg-purple-400/30 animate-pulse"></div>
          </div>
        </div>
        <div className="absolute bottom-[25%] right-[8%] animate-float">
          <div className="w-16 h-16 rounded-full bg-yellow-500/20 backdrop-blur-sm border border-yellow-500/30 flex items-center justify-center">
            <div className="w-10 h-10 rounded-full bg-yellow-400/30 animate-pulse"></div>
          </div>
        </div>
      </div>
      ...
      <div className="container relative z-10 mx-auto px-4 py-16 flex flex-col items-center">
        ...
        <div className="mb-8 text-center">
          <div className="inline-block relative">
            ...
            <div className="relative flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-purple-600 to-indigo-600 border border-purple-400/50 animate-pulse"></div>
          </div>
        ...
        <div className="w-full max-w-md">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="h-5 w-20 rounded-md bg-purple-100/20 animate-pulse"></div>
                    <div className="h-4 w-32 rounded-md bg-purple-300/20 animate-pulse"></div>
                  </div>
                  <div className="h-10 w-full rounded-md bg-gray-800/50 border border-purple-500/30 animate-pulse"></div>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="h-4 w-4 rounded bg-purple-500/50 animate-pulse"></div>
                  <div className="h-4 w-24 rounded-md bg-purple-200/20 animate-pulse"></div>
                </div>
                <div className="h-10 w-full rounded-md bg-gradient-to-r from-purple-600/70 to-pink-600/70 animate-pulse mt-6"></div>
          ...
          <div className="mt-8 flex justify-center">
            <div className="relative w-40 h-40 bg-gradient-to-b from-transparent to-purple-500/10 rounded-full animate-pulse">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-32 h-32 rounded-full bg-gradient-to-r from-purple-400/20 to-pink-400/20 animate-pulse"></div>
              </div>
            </div>
          </div>
        </div>
